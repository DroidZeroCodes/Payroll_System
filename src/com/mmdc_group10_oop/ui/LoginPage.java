...
//
//        // Instantiate AcccessManger
//        AccessManager login = new AccessManager();
//        boolean loginSuccessful = login.Login(username, password);
//
//        // if login successfull, close login interface.
//        if (loginSuccessful) {
//            dispose();
//        }
