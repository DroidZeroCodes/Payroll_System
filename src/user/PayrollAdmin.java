...
import service.actions.PayrollRecords;
import util.Convert;
import user.interfaces.PayrollAdminActions;
import logic.PayrollCalculator;
import ui.payrollAdminUI.PayrollAdminUI;
import ui.payrollAdminUI.PayrollReportPanel;
import ui.payrollAdminUI.RunPayrollPanel;
...
public class PayrollAdmin extends Employee implements PayrollAdminActions {
    ...
    public PayrollAdmin(int employeeID, PayrollAdminUI ui) {
        ...
        this.ui = ui;
        initComponents();
        this.tempPayrollRecords = new ArrayList<>();
    }
        ...
        for (Integer employeeID : employeeIDList){
            ...
            if (hoursWorked > 0.0) {
                ...
                String[] result = new String[]{
                        startDate.getYear() + Convert.MonthValueToString(startDate.getMonthValue()) + "-" + employeeRecord.employeeID(),
