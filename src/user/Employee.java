...
import user.interfaces.LeaveManagement;
import user.interfaces.PayslipManagement;
import util.Convert;
import logic.DateTimeCalculator;
import user.interfaces.AttendanceManagement;
import user.interfaces.ProfileManagement;
...
public class Employee implements ProfileManagement, AttendanceManagement, LeaveManagement, PayslipManagement {
    ...
    public Employee(int employeeID, EmployeeUI ui) {
        ...
        //Initialize employee, Details, and Records
        if (ui != null) {
            this.ui = ui;
            initComponents();
        }
    ...
    public void displayProfile() {
        personalInfo = new EmployeeRecord(employeeID);
    ...
    public void displayAttendanceRecord() {
        attendanceRecords = new AttendanceRecord(employeeID).retrieveAllPersonalRecord();
    ...
    public void submitLeaveRequest() {
        leaveBalance = new LeaveBalance(employeeID);
        leaveRecords = new LeaveRecord(employeeID).retrieveAllPersonalRecord();
    ...
    public void displayPayslip(YearMonth yearMonth) {
        ...
        payslip = new PayrollRecords(employeeID, yearMonth);
