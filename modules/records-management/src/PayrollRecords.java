...
public class PayrollRecords extends Record {
    ...
    public PayrollRecords(int employeeID, YearMonth yearMonth) {
        this.employeeID = employeeID;
        this.payslipID =
                yearMonth.getYear() + Convert.MonthValueToString(yearMonth.getMonthValue()) + "-" + employeeID;
    ...
    protected void retrieveRecord() {
        ...
        record = dataHandler.retrieveRowData(primaryKey(), payslipID);

        if (record == null) {
            record = dataHandler.retrieveRowData(employeeNo(), String.valueOf(employeeID));
        }
        assert record != null;
        setPayslipID(record[0]);
    ...
    public static void main(String[] args) {
        PayrollRecords payrollRecords = new PayrollRecords(15, YearMonth.of(2022, 1));
